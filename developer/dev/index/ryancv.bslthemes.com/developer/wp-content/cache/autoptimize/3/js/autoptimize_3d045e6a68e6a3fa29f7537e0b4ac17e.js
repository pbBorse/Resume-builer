...
(function($) {
    ...
    $(function() {
        ...
        var prop_loop = $('.revs-carousel:not(.revs-two-carousel) .swiper-container').data('swiper-loop');
        var prop_delay = $('.revs-carousel:not(.revs-two-carousel) .swiper-container').data('swiper-delay');
        var prop_autoplay = $('.revs-carousel:not(.revs-two-carousel) .swiper-container').data('swiper-autoplay');
        var objAutoplay = 0;
        if (prop_autoplay) {
            objAutoplay = {
        ...
        var revs_slider_init = new Swiper('.revs-carousel:not(.revs-two-carousel) .swiper-container', {
            spaceBetween: 30,
            slidesPerView: 1,
            observer: true,
            observeParents: true,
            ...
            loop: prop_loop,
            pagination: {
                el: '.revs-carousel:not(.revs-two-carousel) .swiper-pagination',
                clickable: true
            }
        });
        var prop_two_loop = $('.revs-two-carousel .swiper-container').data('swiper-loop');
        var prop_two_delay = $('.revs-two-carousel .swiper-container').data('swiper-delay');
        var prop_two_autoplay = $('.revs-two-carousel .swiper-container').data('swiper-autoplay');
        var prop_two_count = $('.revs-two-carousel .swiper-container').data('swiper-count');
        ...
        var revs_slider_two_init = new Swiper('.revs-two-carousel .swiper-container', {
            spaceBetween: 30,
            ...
            loop: prop_two_loop,
            pagination: {
                el: '.revs-two-carousel .swiper-pagination',
                clickable: true
            },
            breakpoints: {
                0: {
